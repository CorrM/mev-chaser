...
pub mod simulator_abi {
    ...
    impl ::ethers::core::abi::AbiDecode for SimulatorAbiErrors {
        fn decode(data: impl AsRef<[u8]>) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            ...
            if let Ok(decoded) = <EmptyPath as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for SimulatorAbiErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                ...
                Self::EmptyPath(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::ethers::contract::ContractRevert for SimulatorAbiErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector == <EmptyPath as ::ethers::contract::EthError>::selector() => true,
