...
pub mod simulator_abi {
            ...
            functions: ::core::convert::From::from([
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("simulateGetAmountsOutUniswapV2",),
                        inputs: ::std::vec![
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("simulateGetAmountsOutUniswapV3",),
                        inputs: ::std::vec![
                            ::ethers::core::abi::ethabi::Param {
                                name: ::std::borrow::ToOwned::to_owned("router"),
                                kind: ::ethers::core::abi::ethabi::ParamType::Address,
    ...
    impl ::ethers::core::abi::AbiDecode for SimulatorAbiCalls {
        fn decode(data: impl AsRef<[u8]>) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
            if let Ok(decoded) = <SimulateGetAmountsOutUniswapV2Call as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::SimulateGetAmountsOutUniswapV2(decoded));
            }
            if let Ok(decoded) = <SimulateGetAmountsOutUniswapV3Call as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for SimulatorAbiCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                Self::SimulateGetAmountsOutUniswapV2(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::SimulateGetAmountsOutUniswapV3(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::fmt::Display for SimulatorAbiCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::SimulateGetAmountsOutUniswapV2(element) => ::core::fmt::Display::fmt(element, f),
                Self::SimulateGetAmountsOutUniswapV3(element) => ::core::fmt::Display::fmt(element, f),
                Self::SimulateMultiSwap(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    impl ::core::convert::From<SimulateGetAmountsOutUniswapV2Call> for SimulatorAbiCalls {
        fn from(value: SimulateGetAmountsOutUniswapV2Call) -> Self {
            Self::SimulateGetAmountsOutUniswapV2(value)
        }
    }
    impl ::core::convert::From<SimulateGetAmountsOutUniswapV3Call> for SimulatorAbiCalls {
